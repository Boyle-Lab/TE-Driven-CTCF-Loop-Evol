...
# Human-referenced
bedtools intersect -v -a dat.hg -b CTCF.mm9.merged.lifted.bed | awk '{printf "%s\t%d\t%d\t%d\t%d\t1\t0\n", $1, $2, $3, $4, $10}' > tmp
bedtools intersect -v -b dat.hg -a CTCF.mm9.merged.lifted.bed | awk '{printf "%s\t%d\t%d\t%d\t%d\t0\t1\n", $1, $2, $3, $4, $10}' >> tmp
