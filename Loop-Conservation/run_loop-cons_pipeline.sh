...
# 10kb resolution).
/bin/bash do_mapLoopLoci.sh 5 10k ../data/hadoop/chia_pet.dat ../data/liftover
/bin/bash do_mapLoopLoci.sh 10 20k ../data/hadoop/chia_pet.dat ../data/liftover
/bin/bash do_mapLoopLoci.sh 25 50k ../data/hadoop/chia_pet.dat ../data/liftover
