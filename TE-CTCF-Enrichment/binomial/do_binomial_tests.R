...
all_repeats = read.table("../data/hadoop/repeatmasker_with_tss_dists.dat", stringsAsFactors=FALSE, header=FALSE, col.names=c("id_rmsk", "chrom", "chromStart", "chromEnd", "name", "class", "family", "pctDiv", "species", "nearest_gene", "tss_dist"))
...
all_ctcf_repeats = read.table("../../data/hadoop/results/ctcf_te_intersection.all.txt", stringsAsFactors=FALSE, header=FALSE, col.names=c("id_rmsk", "chrom", "chromStart_rmsk", "chromEnd_rmsk", "name_rmsk", "class_rmsk", "family_rmsk", "pctDiv_rmsk", "id_ctcf", "chromStart_ctcf", "chromEnd_ctcf", "signalValue_ctcf", "peak_ctcf", "factor", "species", "cell"))
