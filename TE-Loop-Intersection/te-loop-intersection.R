...
loop_te_data = read.table("ctcf_loop_te_intersection.hg19.txt", header=FALSE, stringsAsFactors=FALSE, sep="\t", col.names=c("id_rp", "chrom", "chromstart_rp", "chromend_rp", "name_rp", "class_rp", "family_rp", "pctdiv_rp", "id_ctcf", "chromstart_ctcf", "chromend_ctcf", "signalvalue_ctcf", "peak_ctcf", "factor", "species", "cell", "id_cp", "start1", "end1", "start2", "end2", "iab", "fdr"))
loop_motif_data = read.table("ctcf_loop_motif_intersection.hg19.txt", header=FALSE, stringsAsFactors=FALSE, sep="\t", col.names=c("id_cp", "chrom", "start1", "end1", "start2", "end2", "iab", "fdr", "cell", "species", "id_ctcf", "chromStart_ctcf", "chromEnd_ctcf", "signalValue_ctcf", "peak_ctcf", "id_mt", "start_mt", "end_mt", "score_mt", "strand_mt"))
loop_te_motif_data = read.table("ctcf_loop_te_motif_intersection.hg19.txt", header=FALSE, stringsAsFactors=FALSE, sep="\t", col.names=c("id_rp", "chrom", "chromStart_rp", "chromEnd_rp", "name_rp", "class_rp", "family_rp", "pctdiv_rp", "id_ctcf", "chromStart_ctcf", "chromEnd_ctcf", "signalValue_ctcf", "peak_ctcf", "factor", "species", "cell", "id_cp", "start1", "end1", "start2", "end2", "iab", "fdr", "id_mt", "chromStart_mt", "chromEnd_mt", "strand_mt", "score_mt"))
hic_te_data = read.table("ctcf_hic_te_intersection.hg19.txt", header=FALSE, stringsAsFactors=FALSE, sep="\t", col.names=c("id_rp", "chrom", "chromstart_rp", "chromend_rp", "name_rp", "class_rp", "family_rp", "pctdiv_rp", "id_ctcf", "chromstart_ctcf", "chromend_ctcf", "signalvalue_ctcf", "peak_ctcf", "factor", "species", "cell", "id_cp", "start1", "end1", "start2", "end2", "iab", "fdr"))
hic_motif_data = read.table("ctcf_hic_motif_intersection.hg19.txt", header=FALSE, stringsAsFactors=FALSE, sep="\t", col.names=c("id_cp", "chrom", "start1", "end1", "start2", "end2", "iab", "fdr", "cell", "species", "id_ctcf", "chromStart_ctcf", "chromEnd_ctcf", "signalValue_ctcf", "peak_ctcf", "id_mt", "start_mt", "end_mt", "score_mt", "strand_mt"))
hic_te_motif_data = read.table("ctcf_hic_te_motif_intersection.hg19.txt", header=FALSE, stringsAsFactors=FALSE, sep="\t", col.names=c("id_rp", "chrom", "chromStart_rp", "chromEnd_rp", "name_rp", "class_rp", "family_rp", "pctdiv_rp", "id_ctcf", "chromStart_ctcf", "chromEnd_ctcf", "signalValue_ctcf", "peak_ctcf", "factor", "species", "cell", "id_cp", "start1", "end1", "start2", "end2", "iab", "fdr", "id_mt", "chromStart_mt", "chromEnd_mt", "strand_mt", "score_mt"))
